...
public class PendingComplainFinalListAdapter extends RecyclerView.Adapter<PendingComplainFinalListAdapter.ViewHolder> {
   ...
   /* public PendingComplainListAdapter(Context mContext, List<ComplainAllResponse> mComplainAllResponse) {
    ...
    public PendingComplainFinalListAdapter(Context mContext, List<ComplainAllResponse> mComplainAllResponse, String mStatusValue) {
        this.mContext = mContext;
        this.mComplainAllResponse = mComplainAllResponse;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view1 = LayoutInflater.from(mContext).inflate(R.layout.pending_comp_final_item_row, parent, false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView txtViewPhotoID, txtViewRmarkID;
