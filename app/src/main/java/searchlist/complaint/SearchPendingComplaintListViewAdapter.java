...
public class SearchPendingComplaintListViewAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            holder.pending_reason = view.findViewById(R.id.pending_reason);
...
//        });
    ...
    public class ViewHolder {
        ...
        TextView cmpno, cmpdt,cmppnddy,epc_txt, customer_name, address,pending_reason, mobile_no, mobile_no1, dealer_name, employee_name, mobile_image, mobile_image1, address_image, comp_dtl, comp_action, comp_start,comp_iss_mat_txt;
