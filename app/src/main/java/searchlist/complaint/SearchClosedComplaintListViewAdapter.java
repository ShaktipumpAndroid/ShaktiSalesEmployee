...
public class SearchClosedComplaintListViewAdapter extends BaseAdapter {
    ...
    public SearchClosedComplaintListViewAdapter(Context context, List<SearchComplaint> complaintSearchlist) {
        mContext = context;
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        holder.comp_dtl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("complaint_display", "closed");
...
//        });
    ...
    public class ViewHolder {
        ...
        TextView cmpno, cmpdt,epc_txt, customer_name, address, mobile_no, mobile_no1, dealer_name, employee_name, mobile_image, mobile_image1, address_image, comp_dtl;
