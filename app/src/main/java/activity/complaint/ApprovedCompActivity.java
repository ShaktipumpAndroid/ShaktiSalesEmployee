...
public class ApprovedCompActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Complaint Approved");
    ...
    public void getCompAppComplaint() {
    ...
    public void getCompAppComplaint1(int d1,int d2) {
    ...
    public void onRestart() {
        ApprovedCompActivity.this.finish();
        super.onRestart();
