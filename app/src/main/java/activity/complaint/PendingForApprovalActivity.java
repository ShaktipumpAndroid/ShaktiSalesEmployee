...
public class PendingForApprovalActivity extends AppCompatActivity {
    EditText editsearch;
    ListView list;
    ...
    android.os.Handler mHandler = new android.os.Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            Toast.makeText(PendingForApprovalActivity.this, mString, Toast.LENGTH_LONG).show();
        }
    };
...
//            + " AND " + DatabaseHelper.KEY_CMPLN_STATUS  + " != '" + "REPLY" + "'" ;
            ...
            if (cursor.getCount() > 0) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    arraylist.add(sc);
                     ...
                     adapter = new PendAppComplaintListViewAdapter(this, arraylist,"P");
    ...
    public void downloadComplaint() {
        ...
        progressDialog = ProgressDialog.show(PendingForApprovalActivity.this, "", "Download Complaint...!");

        new Thread() {

            public void run() {

                if (CustomUtility.isOnline(PendingForApprovalActivity.this)) {

                    try {

                        con.getCustomerComplaint(PendingForApprovalActivity.this);
                        ...
                        PendingForApprovalActivity.this.finish();
                        Intent intent = new Intent(mContex, PendingForApprovalActivity.class);
